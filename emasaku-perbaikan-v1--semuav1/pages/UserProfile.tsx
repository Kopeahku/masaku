...
const defaultNavItems: NavItem[] = [
  ...
  { id: 'deploy', section: 'Pengaturan & Bantuan', iconName: 'CloudArrowUpIcon', label: 'Deploy ke Cloudflare', actionType: 'page', actionValue: 'Deploy Cloudflare', roles: [UserRole.DEVELOPER] },

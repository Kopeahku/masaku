...
// Ini lebih efisien daripada membuat instance baru di setiap panggilan fungsi.
let ai: GoogleGenAI | null = null;
if (API_KEY) {
  ai = new GoogleGenAI({ apiKey: API_KEY });
} else {
  console.warn("API_KEY untuk Gemini tidak diatur. Fitur-fitur berbasis AI akan dinonaktifkan.");
}

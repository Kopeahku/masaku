...
import DeployCloudflarePage from './pages/DeployCloudflarePage.tsx';
...
const App: React.FC = () => {
    ...
    const [selectedLaundryService, setSelectedLaundryService] = useState<LaundryServiceType>(LaundryServiceType.KILOAN);
    ...
    const renderActivePage = () => {
        ...
        switch(activePage) {
            ...
            case 'Deploy Cloudflare': return <DeployCloudflarePage setActivePage={setActivePage} />;
            default:
